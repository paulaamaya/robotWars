...
2. Open your command line and navigate to the `robotWars\target\classes` directory.
...
```bash
java --module-path "C:\ProgramFiles\Java\javafx-sdk-21.0.1.lib" --add-modules javafx.controls, javafx.fxml -jar robotWars.jar
```
